...
class XiaoLiuRen:
    ...
    def divine(self, n1: int, n2: int, n3: int) -> dict:
        ...
        # Step 2: 從起點數 n2 步
        step2_idx = (start_idx + n2 - 1) % 6
        step2 = self.BASE_SIX[step2_idx]
        
        # Step 3: 從中點數 n3 步
        final_idx = (step2_idx + n3 - 1) % 6
...
def main():
    ...
    parser.add_argument("--n1", type=int, help="第一個數字")
    parser.add_argument("--n2", type=int, help="第二個數字")
    parser.add_argument("--n3", type=int, help="第三個數字")
    ...
    try:
        if args.random:
            import random
            n1, n2, n3 = random.randint(1, 6), random.randint(1, 6), random.randint(1, 6)
