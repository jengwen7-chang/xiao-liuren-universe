...
const GRID = {
    ...
    5: { name: "小吉", 五行: "水", 方位: "正北", 特質: "起步、不多、尚可", 神煞: "六合", 意義: "貴人",
    ...
    8: { name: "桃花", 五行: "土", 方位: "東北", 特質: "欲望、牽絆、異性", 神煞: "紅鸞", 意義: "感情",
...
class XiaoLiuRen {
    ...
    divineByTime(month, day, hour) {
        ...
        let idx = (month + day + hour - 3) % 9;
        if (idx < 0) idx += 9;
        const result = NINE_GRID[idx];
...
module.exports = { XiaoLiuRen, GRID, NINE_GRID };
