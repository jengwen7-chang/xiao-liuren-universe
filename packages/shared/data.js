...
const gridByName = Object.values(grid).reduce((acc, item) => {
    acc[item.name] = item;
    return acc;
}, {});

const nineGrid = ["大安", "留連", "速喜", "赤口", "小吉", "空亡", "病符", "桃花", "天德"];
const baseSix = ["大安", "留連", "速喜", "赤口", "小吉", "空亡"];

module.exports = { grid, gridByName, nineGrid, baseSix };
